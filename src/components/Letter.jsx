              ...
              <div className="letter" ref={letterRef}>
                <div className="body">
                  ...
                  <div className="message">
                    Dear Love, <br /> Thank you for the amazing 5 years 1 month
                    and 13 days. I will always love you. Happy Valentine to my
                    dearest wife. You are the reason of my happiness.
                  </div>
                </div>
              </div>
            </div>
